...
<head>
    ...
    <?php if (get_option(OM_THEME_PREFIX . 'responsive') == 'true') : ?>
        <meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1"/><?php endif; ?>
...
<!--[if lt IE 8]><p class="chromeframe"><?php _e('You are using an <strong>outdated</strong> browser. Please, <a
    href="http://browsehappy.com/">upgrade to a different browser</a> or <a
    href="http://www.google.com/chromeframe/?redirect=true">install Google Chrome Frame</a> to experience this
    site.','om_theme'); ?></p><![endif]-->
<div class="bg-overlay">
    <div class="container-wrapper">
        <div class="hc-wrapper">
            <?php global $page_slider;
            if (isset($page_slider) && $page_slider && $page_slider['layout'] == 'before_header') om_tpl_header_slider($page_slider) ?>
            <?php $header_layout = get_option(OM_THEME_PREFIX . 'header_layout');
                            ...
                            <div class="container">
                                <div class="container-inner">
                                    <?php if ($wpml_selector) { ?>
                                        <div class="header-wpml-selector"><?php do_action('icl_language_selector'); ?>
                                    ...
                                    <?php if ($header_social_icons) { ?>
                                        <div
                                            class="header-socials<?php echo esc_attr(($color = get_option(OM_THEME_PREFIX . 'social_icons_color_header')) ? ' ' . $color . '-social-icons' : '') ?>">
