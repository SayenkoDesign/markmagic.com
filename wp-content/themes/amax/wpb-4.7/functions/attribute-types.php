...
add_shortcode_param('attach_video', 'om_wpb_attribute_attach_video', TEMPLATE_DIR_URI . '/wpb-4.7/assets/js/attributes.js');
...
add_shortcode_param('om_get_code', 'om_wpb_attribute_om_get_code', TEMPLATE_DIR_URI . '/wpb-4.7/assets/js/attributes.js');
...
add_shortcode_param('om_categories', 'om_wpb_attribute_om_categories', TEMPLATE_DIR_URI . '/wpb-4.7/assets/js/attributes.js');
...
add_shortcode_param('om_categories_multiple', 'om_wpb_attribute_om_categories_multiple', TEMPLATE_DIR_URI . '/wpb-4.7/assets/js/attributes.js');